                    ...
                    <div className ="jss187" style={{backgroundImage:"url('covid20.jpg')"}}>
                        <div className="jss190">
                            <div className="jss294">
                                <div className="jss2">
                                <h2 className="jss6">
                                It helps to identify people who are at high risk for coronavirus, help expedite their access to screening and to medical care and reduce spread of this infectious disease.
                                        It includes a record of who took the test with a small snippet of information about the user’s browser version and the operating system.
                                     </h2>
                                <h1 style={{color:"black",marginLeft:"1em",marginTop:"0em"}}>VirusRadar </h1>
                                </div>
                            </div>
                        </div> 
